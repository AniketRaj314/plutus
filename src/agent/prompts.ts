...
- When another person pays for the user outside a tracked account, store a person-scoped context fact whose key starts counterparty_payable_ and whose JSON includes {"status":"outstanding","label":"What they paid for","amount_owed_inr":123,"recorded_on":"YYYY-MM-DD","notes":"..."}. A later payment is a separate counterparty_transfer; do not erase or mutate the original obligation.
